...
class GraphSample(object):
    ...
    def __init__(self, x=None, edge_idx=None, edge_wht=None, gt=None, xyz=None, face=None, age=None, sx=None, lab=None):
        ...
        Args:
            ...
            gt --> (Tensor, optional): One-Hot_Encoded manual parcels:[num_nodes, num_classes]. 
            ...
            lab --> (Tensor, optional): OneHot_encoded FreeSurfer parcel labels [num_nodes, num_classes].
        """
